...
import avatar from 'assets/img/2.png';
// logo for sidebar
import logo from "logo.png";
import brown from "assets/img/2.png";
    ...
    render(){
        return (
            ...
            <div className="sidebar" data-color="black" data-image={image}>
                ...
                <div className="logo">
                	<a href="https://api.bokri.io" className="simple-text logo-mini">
                        <div className="logo-img">
                            <img src={logo}/> 
                        </div>
                	</a>
                        <a href="http://api.bokri.io:444" className="simple-text logo-normal">
                          {"\0"}
                        </a>
                </div>
                        ...
                        <div className="info">
                            ...
                            <Collapse in={this.state.openAvatar}>
                                <ul className="nav">
                                    <li>
                						<a>
                							<span className="sidebar-mini">PR</span>
